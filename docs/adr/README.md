...
| [0019](./0019-streamable-http-transport.md) | 두 번째 transport 로 Streamable HTTP 를 추가하고, 진단을 transport 별 유니온으로 나눈다 | core | 초안 |
...
그리고 **또 일어났습니다.** 입력 계약 대조 배선 ADR 이 자기 브랜치에서 0017 을 집었는데, 그
사이에 승인 지문 ADR 이 0017 로 재번호돼 main 에 들어왔습니다. 같은 선례를 따라 나중에 들어온
쪽을 [0018](./0018-입력-계약-대조-소비자-배선.md) 로 옮겼습니다. 세 번째입니다.
