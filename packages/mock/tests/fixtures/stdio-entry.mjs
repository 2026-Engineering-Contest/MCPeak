...
// 그 리졸버는 ".js" 를 ".ts" 로 매핑하지 않는다 — 그래서 src/index.ts 와 그것이 부르는
// 모듈들은 확장자를 ".ts" 로 쓴다. 여기에 ".js" 를 쓰면 ERR_MODULE_NOT_FOUND 로 서버가
// 즉시 죽고, 테스트에는 "요청 완료 전 MCP 서버가 종료되었습니다" 로만 보인다.
